...
The deck cites `reports/2026-05/metrics/monthly_v3_normalized_measurements_20260525.csv` and this notes file as its numeric source. The CSV contains the source file and warmup rule for each row.
