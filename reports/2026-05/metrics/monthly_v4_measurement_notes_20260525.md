...
Numeric source: `reports/2026-05/metrics/monthly_v4_normalized_measurements_20260525.csv` plus measurement notes. The CSV contains the source file and warmup rule for each row.
